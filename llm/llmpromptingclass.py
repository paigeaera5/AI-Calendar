...
if __name__ == "__main__":
    ...
    print("Event description for sub-task #1: " + prompt1.generate_event_description(1))
    print("Event description for sub-task #2: " + prompt1.generate_event_description(2))
    print("Event description for sub-task #3: " + prompt1.generate_event_description(3))
    print("Event description for sub-task #4: " + prompt1.generate_event_description(4))
